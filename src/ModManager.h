...
namespace ModManager
{
    ...
    bool install_mod(const std::string &path, const std::string &modPath, const std::string &gamePath);
    bool uninstall_mod(const std::string &path, const std::string &modPath);
    bool uninstall_pak_mod(const std::string &path, const std::string &modPath, const std::string &gamePath);
